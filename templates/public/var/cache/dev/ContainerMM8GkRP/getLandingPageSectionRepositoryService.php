 ...
 */
class getLandingPageSectionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LandingPageSectionRepository' shared autowired service.
     *
     * @return \App\Repository\LandingPageSectionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LandingPageSectionRepository.php';

        return $container->privates['App\\Repository\\LandingPageSectionRepository'] = new \App\Repository\LandingPageSectionRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
