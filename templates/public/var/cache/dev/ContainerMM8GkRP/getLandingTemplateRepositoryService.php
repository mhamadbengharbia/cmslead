 ...
 */
class getLandingTemplateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LandingTemplateRepository' shared autowired service.
     *
     * @return \App\Repository\LandingTemplateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LandingTemplateRepository.php';

        return $container->privates['App\\Repository\\LandingTemplateRepository'] = new \App\Repository\LandingTemplateRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
